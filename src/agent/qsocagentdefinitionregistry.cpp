...
void QSocAgentDefinitionRegistry::registerBuiltins()
{
    ...
    explore.toolsAllow = QStringList{
        QStringLiteral("agent_list"),   QStringLiteral("send_message"),
        QStringLiteral("agent_inbox"),  QStringLiteral("wait_agent"),
        QStringLiteral("read_file"),    QStringLiteral("tool_output_read"),
        QStringLiteral("list_files"),   QStringLiteral("path_context"),
        QStringLiteral("module_list"),  QStringLiteral("module_show"),
        QStringLiteral("bus_list"),     QStringLiteral("bus_show"),
        QStringLiteral("project_list"), QStringLiteral("project_show"),
        QStringLiteral("query_docs"),   QStringLiteral("skill_find"),
        QStringLiteral("lsp"),          QStringLiteral("memory_read"),
